...
#ifdef GRAPHICSMODE
    Desktop desktop(320,200,ROYAL_BLUE);
#endif
...
#ifdef GRAPHICSMODE
    Window *win1 = new Window(&desktop, 10,10,50,50, 0x16);
    desktop.AddChild(win1);
    Window *win2 = new Window(&desktop, 40,15,30,30, 0x17);
    desktop.AddChild(win2);

    /*desktop.RemoveChild(win1);
    win1->~Window();
    delete win1;

    desktop.RemoveChild(win2);
    win2->~Window();
    delete win2;*/
